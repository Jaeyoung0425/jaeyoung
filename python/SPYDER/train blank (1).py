...
optimizer = optim.Adam(model.parameters(), lr=0.01) # optim.Adam(model.parameters(), lr=0.01)
...
#%%
print(title_list)
#title_list = 문장을 단어로 split 하고, 소문자로 바꿔주고, 공백 및 괄호 제거된 것들만 남음
[큰 list안에 각 문장들이 쪼개진 형태로 [] 리스트가 중복으로 들어가있음] 
#%%
